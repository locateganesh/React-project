...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 300], [0, -200]);
  const opacityCity = useTransform(scrollY, [0, 200], [1, 0.5]); // first [] is breakpoint, second [] is value of breakpoints.
  // [20, 200] scroll form 0 to 200 and [1, 0.5] is opacity from 1 to 0.5 on scroll from 0 to 200
  
  const yHero = useTransform(scrollY, [0, 200], [0, -150]);
  const opacityHero = useTransform(scrollY, [0, 200, 500], [1, 1, 0]);
  const scaleText = useTransform(scrollY, [0, 300], [1, 1.5]);
  const yText = useTransform(scrollY, [0, 300], [1, -100]);
